...
def findContours_img(original_img, opened):
    contours, hierarchy = cv2.findContours(cv2.Canny(original_img, 50, 200), cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
...
if __name__ == "__main__":
    ...
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    cv2.imwrite('../../img/201912082029_redess.png', result_img)
